...
export const labShortcuts = [
  // --- IDENTIDAD DE LABORATORIO (ATÓMICA) ---
  ['kode-terminal', 'bg-matrix-dark border border-matrix-green/30 font-mono text-matrix-green shadow-[0_0_20px_rgba(0,255,65,0.1)]'],
